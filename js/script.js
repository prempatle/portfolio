...
function viewwebpage1() {
  window.open("https://www.alzare.com/");
}
function viewwebpage2() {
  window.open("https://ocr.alkurn.co.in/");
}
function viewwebpage3() {
  window.open("https://www.ornatejewels.com/");
}
function viewwebpage4() {
  window.open("http://www.tacollynn.com/");
}
function viewwebpage5() {
  window.open("https://tazdeer.alkurn.co.in/");
}
function viewwebpage6() {
  window.open("https://socialshowroom.co/");
}
function cvdownload() {
  window.open("./prem_cv.docx");
}